...
Feature: game journal
  ...
  Scenario Outline: the journal records a debtor putting a property up for sale and the sole buyer's winning offer
    ...
    And the game journal records that pawn "high hat" offers $<high_hat_starting_balance> for "Lippenslaan Knokke"
    And the game journal records that pawn "high hat" wins the distressed sale for "Lippenslaan Knokke" at $<high_hat_starting_balance>
