...
Feature: game journal
  ...
  # journal-98
  # Reuses journal-90's own numbers (dog starting at position 37, rolling
  # 1 and 2, collecting $200 salary) since this scenario's purpose is
  # proving the narration line exists, not re-verifying the computation
  # unified-income-tax-2 already covers for that exact figure ($150.88,
  # the no-rent-collected case).
