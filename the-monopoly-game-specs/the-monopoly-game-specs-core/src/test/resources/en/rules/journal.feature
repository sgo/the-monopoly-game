...
Feature: game journal
  ...
  # journal-70
  Scenario Outline: the journal records each remaining player's final balance and age once the game ends because the year limit was reached
    ...
    And pawn "high hat"'s account holds $<high_hat_starting_account>
    When we play the game
    Then the game journal records that the game ends because the year limit was reached before it records that pawn "dog"'s final balance is $<dog_final_balance>
    And the game journal records that pawn "dog"'s final balance is $<dog_final_balance> before it records that pawn "dog"'s final age is <dog_final_age> years
    And the game journal records that pawn "dog"'s final age is <dog_final_age> years before it records that pawn "high hat"'s final balance is $<high_hat_final_balance>
    And the game journal records that pawn "high hat"'s final balance is $<high_hat_final_balance> before it records that pawn "high hat"'s final age is <high_hat_final_age> years
  ...
  # journal-85
  Scenario Outline: the journal records a player's war profits tax payment
  ...
  # journal-86
  Scenario Outline: the journal records the government's final account balance once the game ends
    Given the war profits tax is enabled
    And pawn "dog"'s land is currently worth $<land_value> in rent
    And pawn "dog" has collected $<collected> in rent since their last war profits tax assessment
    And pawn "dog" grows a year older
    When we play up to 1 round
    Then the game journal records that the government's final account balance is $<balance>
  ...
  # journal-89
  Scenario Outline: the journal records the government's final account balance once an ordinary win ends the game too
    Given the war profits tax is enabled
    And pawn "dog"'s land is currently worth $<land_value> in rent
    And pawn "dog" has collected $<collected> in rent since their last war profits tax assessment
    And pawn "dog" grows a year older
  ...
  # journal-87
  Scenario Outline: the journal records that the war profits tax is enabled, near the start of the game
    Given the war profits tax is enabled
    When we play the game
  ...
  # journal-88
  Scenario Outline: the journal records that the war profits tax is disabled by default, near the start of the game
    When we play the game
    Then the game journal records that the war profits tax is <state>
