...
Feature: Monopoly command line interface
  ...
  # cli-20
  # No MegaCorp-style cross-check (like cli-19) is needed: unlike
  # MegaCorp's salary tax, this flag does not depend on
