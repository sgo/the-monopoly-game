...
public class Greedo implements Strategy {
  ...
  /**
   * Ordinary (landing) auctions follow a three-tier interest rule: completing the
   * bidder's own colour group or arming a utility monopoly is worth whatever is
   * available; denying an opponent's highest-priority monopoly is worth a bounded
   * share (35%) of the balance; anything else is worth nothing. Preventing a flat
   * bid from converting a large opening capital into a single property (the
   * Billionaire overbidding defect) is the point of gating the bid this way.
   */
  @Override
...
version=1
moduleHash=6f4ae46450f581b1ea173b612ed89ed67b7ab46052798a36b895a4e6ca2d3645
scope.0.id=Y2xhc3M6R3JlZWRvI0dyZWVkbzoxOQ
scope.0.kind=class
scope.0.startLine=19
scope.0.endLine=221
scope.0.semanticHash=46e4b9a519614e58b97b81ef54e88b8931cbe267baf0eecab1bf3fcbf7e0efb7
...
scope.7.id=bWV0aG9kOkdyZWVkbyNiaWRGb3JBdWN0aW9uKDQpOjE5OQ
scope.7.kind=method
scope.7.startLine=199
scope.7.endLine=205
scope.7.semanticHash=af55ec5c11834a5ad5815af0cd4069b0419e4709773f67d070e4a37bba7b1dc4
...
scope.9.id=bWV0aG9kOkdyZWVkbyNidWlsZHMoMSk6MjEy
scope.9.kind=method
scope.9.startLine=212
scope.9.endLine=215
...
scope.12.id=bWV0aG9kOkdyZWVkbyNjbGFpbXMoMSk6MjA3
scope.12.kind=method
scope.12.startLine=207
...
scope.23.id=bWV0aG9kOkdyZWVkbyNwYXlzKDEpOjIxNw
scope.23.kind=method
scope.23.startLine=217
scope.23.endLine=220
